...
// Your job is to write a function named finder that will get a random
//number (by invoking getRandomArbitrary), then loop through the array (that
//will be passed in as a parameter) to see if that random number is in the array.
...
/*
  ...
  item in myGroceryList, remove that item from the your grocery list and return the new, updated grocery list.
